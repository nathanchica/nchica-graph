...
describe('createBusStopParent', () => {
    it.each([
        ...
        { input: { code: '12345', position: createPositionParent({ latitude: 37.7749, longitude: -122.4194 }) } },
        {
            input: {
                code: '54321',
                id: 'GTFS_STOP_987',
                name: 'Uptown',
                position: createPositionParent({ latitude: 34.0522, longitude: -118.2437, heading: 90, speed: 30 }),
            },
        },
